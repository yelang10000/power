...
/**
 * @Description: 日历转换工具类：阴历和阳历日期互换(阴历日期范围1900-01-01~2049-12-29)
 * @Author: 贾涛
 * @CreateDate: 2019/4/29 16:48
 * @UpdateUser: 贾涛
 * @UpdateDate: 2019/4/29 16:48
 * @UpdateRemark: 修改内容
 * @Version: 1.0
 */
public class CalendarUtil {
    ...
    public static String lunarToSolar(String lunarDate) throws Exception {
        ...
        myDate = c.getTime();
        String m = formatter.format(myDate);
        StringBuffer stringBuilder = new StringBuffer(m);
    ...
    public static void main(String[] args) throws Exception {
        //阴历转阳历
        System.out.println(CalendarUtil.lunarToSolar("1991-07-01"));
        System.out.println("************");
        //阳历转阴历
        System.out.println(CalendarUtil.solarToLunar("2020-08-10"));
        System.out.println(CalendarUtil.solarToLunar("2017-07-29"));
